            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-custom">
                    <div class="login-register-wrapper">
                        ...
                        <form:form action="${pageContext.request.contextPath}/pages/register" method="post" modelAttribute="detailUser">
                            <div class="single-input-item mb-3">
                                <form:input type="text" path="fullName" placeholder="FullName"/>
