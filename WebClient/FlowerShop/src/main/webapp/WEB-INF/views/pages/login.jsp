            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-custom">
                    <div class="login-register-wrapper">
                        ...
                        <form:form action="${pageContext.request.contextPath}/pages/login" method="post" modelAttribute="loginModel">
                            <div class="single-input-item mb-3">
                                <form:input type="text" path="loginName" placeholder="Email or Phone"/>
                                <form:errors style="color:red" path="loginName"/>
                            </div>
                            <div class="single-input-item mb-3">
                            ...
                            <div class="single-input-item mb-3">
                                <div class="login-reg-form-meta d-flex align-items-center justify-content-between">
                                    ...
                                    <a href="${pageContext.request.contextPath}/pages/forgotPassword" class="forget-pwd mb-3">Forget Password?</a>
                                </div>
                            </div>
                            <div class="single-input-item mb-3">
