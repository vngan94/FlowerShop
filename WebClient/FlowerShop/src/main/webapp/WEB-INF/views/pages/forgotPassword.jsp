            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-custom">
                    ...
                    <!-- Xử Lý Form login  -->
                        ...
                        <form:form action="${pageContext.request.contextPath}/pages/forgotPassword" method="post">
                         ...
                         <div class="error_form">
	                       ...
	                       <!--  Send Success. Check your email to reset password.-->
	                        <a href="${pageContext.request.contextPath}/pages/login">Back to login page</a>
	                      </div>
                    </div>
                </div>
            </div>
