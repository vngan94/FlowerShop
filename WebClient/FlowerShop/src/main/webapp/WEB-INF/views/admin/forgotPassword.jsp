                ...
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-custom">
                    <div class="login-register-wrapper">
                        <div class="section-content text-center mb-5">
                            ...
                            <h2 class="title-4 mb-2">Admin's Password</h2>
                            <p class="desc-content">Please enter your username in the box below.</p>
                            <p class="desc-content">Email with new password will be sent to your email.</p>
                        </div>
                    <!-- Xử Lý Form login  -->
                        <div class="mb-3" style=" color: red">${message}</div>
                        <form:form action="${pageContext.request.contextPath}/admin/forgotPassword.htm" method="post">
                            <div class="single-input-item mb-3" style="display:flex">
                                <input type="text" name=username placeholder="Enter your Admin's Username">
                         ...
                         <div class="error_form">
	                       ...
	                       <!--  Send Success. Check your email to reset password.-->
	                        <a href="${pageContext.request.contextPath}/admin/login.htm">Back to login page</a>
	                      </div>
                    </div>
                </div>
            </div>
