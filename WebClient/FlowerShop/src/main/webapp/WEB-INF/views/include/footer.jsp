...
<body>
<!--Footer Area Start-->
    <footer class="footer-area mt-no-text" id ="footer_main">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-2 col-custom">
                        <div class="single-footer-widget">
                            ...
                            <ul class="widget-list">
                                <li><a href="${pageContext.request.contextPath}/pages/about_us">Our Company</a></li>
                                <li><a href="${pageContext.request.contextPath}/pages/contact_us">Contact Us</a></li>
                                <li><a href="${pageContext.request.contextPath}/pages/about_us">Our Services</a></li>
                                <li><a href="${pageContext.request.contextPath}/pages/about_us">Why We?</a></li>
                                <li><a href="${pageContext.request.contextPath}/pages/about_us">Careers</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-2 col-custom">
                        <div class="single-footer-widget">
                            ...
                            <ul class="widget-list">
                                <li><a href="${pageContext.request.contextPath}/pages/about_us">About</a></li>
                                <li><a href="${pageContext.request.contextPath}/blog/main">Blog</a></li>
                                <li><a href="${pageContext.request.contextPath}/shop/main">Shop</a></li>
                                <li><a href="${pageContext.request.contextPath}/shop/main">Product</a></li>
                                <li><a href="${pageContext.request.contextPath}/pages/contact_us">Contact</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-6 col-lg-2 col-custom">
                        <div class="single-footer-widget">
                            ...
                            <ul class="widget-list">
                                <li><a href="${pageContext.request.contextPath}/pages/contact_us">Online Support</a></li>
                                <li><a href="${pageContext.request.contextPath}/pages/contact_us">Shipping Policy</a></li>
                                <li><a href="${pageContext.request.contextPath}/pages/contact_us">Return Policy</a></li>
                                <li><a href="${pageContext.request.contextPath}/pages/contact_us">Privacy Policy</a></li>
                                <li><a href="${pageContext.request.contextPath}/pages/contact_us">Terms of Service</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 text-center col-custom">
                        <div class="copyright-content">
                            <p>Copyright © 2022 <a href="dndflowershop@gmail.com" title="dndflowershop@gmail.com">DND FLOWER SHOP</a> | Built with&nbsp;<strong>Flower Shop</strong>&nbsp;by <a href="dndflowershop@gmail.com" title="dndflowershop@gmail.com">DND Group</a>.</p>
                        </div>
                    </div>
                </div>
            </div>
