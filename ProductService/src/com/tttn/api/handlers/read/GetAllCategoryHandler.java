...
public class GetAllCategoryHandler extends APIHandler<APIRequest, DefaultResponseData> {
    ...
    protected DefaultResponseData handle(APIRequest request) throws Exception {
        ...
        List<RGetCategory> listQuery = new ArrayList<>();
        listQuery = FlowerService.getAllCategory();
        List<Map<String,Object>> data = listQuery.stream().map(RGetCategory::getValueMap).collect(Collectors.toList());
        response.setData(data);
        I18n.load(Global.locale);
        String message = I18n.get("getAllCategorySuccess");
